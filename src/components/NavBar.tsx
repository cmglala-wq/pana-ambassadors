  ...
  return (
    <header className={`fixed top-0 inset-x-0 z-50 transition-all ${scrolled ? 'py-2.5' : 'py-4'}`}>
      <div className="mx-auto max-w-7xl px-5">
        <div className={`flex items-center justify-between rounded-full px-4 md:px-5 py-2 transition-all ${scrolled ? 'glass-strong shadow-2xl shadow-black/40' : ''}`}>
          ...
          <div className="flex items-center gap-2">
            {user ? (
              ...
              <Link to="/login" className="btn-lime !py-2.5 !px-4 text-sm">
                Acceso embajadores

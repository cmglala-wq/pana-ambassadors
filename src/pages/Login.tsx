...
export default function Login() {
  ...
  function tryGoogle() {
    setBusy(true);
    // CF Access protects /dashboard at the edge — going there triggers the
    // Google login flow (or returns identity if JWT cookie is already valid).
    ...
    <div className="min-h-screen flex items-center justify-center px-5 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="rounded-[28px] glass-strong p-8 md:p-10 animate-fadeUp">
          ...
          {/* Google login is only meaningful on the admin URL (CF Access protected). */}
          {/* On the public site, embajadores enter via demo or future tech-defined auth. */}
          {isAdminHost() && (
            <>
              <button
                onClick={tryGoogle}
